            ...
            <nav className="bg-violet-800 border-b border-gray-100">
                    ...
                    <div className="flex justify-between h-16">
                        <div className="flex">
                            <div className="shrink-0 flex items-center">
                                <Link href="/lowonganKerja">
                                    <p className='font-bold border border-white p-2 text-white' >TIFCAREER</p>
                                </Link>
                            </div>

                            <div className="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                                <NavLink href={route('dashboardAdmin')} active={route().current('dashboardAdmin')} className='text-white'>
                                    Dashboard
                                </NavLink>
                                <NavLink href={route('companyPermission')} active={route().current('companyPermission')} className='text-white'>
                                    Company Permission
                                </NavLink>
                                <NavLink href={route('applicantPermission')} active={route().current('applicantPermission')} className='text-white'>
                ...
                <div className={(showingNavigationDropdown ? 'block' : 'hidden') + ' sm:hidden'}>
                    <div className="pt-2 pb-3 space-y-1">
                        <ResponsiveNavLink href={route('dashboardAdmin')} active={route().current('dashboardAdmin')}>
                            Dashboard
                        </ResponsiveNavLink>
                    </div>
