                    ...
                    <div className="flex justify-between h-16">
                        <div className="flex">
                            ...
                            <div className="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                                <NavLink href={route('dashboard-perusahaan')} active={route().current('dashboard-perusahaan')}>
                                    Buat Lowongan Kerja
                                </NavLink>
                                <NavLink href={route('LowonganKerjaPerusahaan')} active={route().current('LowonganKerjaPerusahaan')}>
