...
const FormNewCertificate = ({ auth, processing, errors, Transition }) => {

    console.log('id certificate yang ke get:', auth.user);

    const [title, setTitle] = useState('');
    const [description, setDescription] = useState('');
    const [no_certificate, setNoCertificate] = useState('');
...
export default FormNewCertificate