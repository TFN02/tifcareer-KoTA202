...
const FormNewSoftSkill = ({ auth, processing, errors, Transition }) => {

    console.log('id softskill yang ke get:', auth.user);
    ...
    return (
        ...
        >
            ...
            <div className="p-5">
                ...
                <figure><h1 className='text-lg bg-violet-700 text-white w-full p-5'>Softskill</h1></figure>
...
export default FormNewSoftSkill